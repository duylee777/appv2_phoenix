...
<section class="bg-gray-50 py-4 sm:py-5 mt-5">
    <div class="px-4 mx-auto max-w-screen-2xl">
        ...
        <div class="flex items-center justify-between flex-1 mb-4">
            <h2 class="text-blue-600 text-2xl font-semibold">Thêm đại lý mới</h2>
        ...
        <form  method="POST" action="{{ route('agency.store') }}" class="" enctype="multipart/form-data">
            @csrf
                ...
                <div class="">
                    <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="email" id="email" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập email ..." required="">
                        </div>
                        <div class="col-span-2">
