...
<section class="bg-gray-50 py-4 sm:py-5 mt-5">
    <div class="px-4 mx-auto max-w-screen-2xl">
        <a href="{{ route('post.index') }}" class="mb-4 inline-flex items-center gap-1 px-4 py-2 bg-white shadow rounded hover:bg-gray-100">
        ...
        <div class="flex items-center justify-between flex-1 mb-4">
            <h2 class="text-blue-600 text-2xl font-semibold">Thêm bài viết mới</h2>
        ...
        <form  method="POST" action="{{ route('post.store') }}" class="" enctype="multipart/form-data">
                ...
                <div class="">
                    <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" id="description" cols="" rows="3" class="w-full focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nhập mô tả ..."></textarea>
                        </div>
                    </div>
                    <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                        <div class="sm:col-span-2">
                            <label for="image" class="block mb-2 font-semibold text-gray-900">Ảnh bìa của bài viết</label>
                            <div id="list-post-image" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"></div>
            ...
            <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                <div class="sm:col-span-2">
                    ...
                    <textarea name="detail" id="detail" cols="" rows="3" class=" w-full focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nhập nội dung ..."></textarea>
                    <script>
