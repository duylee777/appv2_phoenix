<button type="button" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block p-2 shadow-lg rounded-lg bg-white text-blue-600 border border-blue-300">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                <form action="{{ route('admin.excel.import-products') }}" method="POST" enctype="multipart/form-data">
                    @csrf
